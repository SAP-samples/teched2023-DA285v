...
SELECT P1.ST_MAKELINE(P2).ST_ASEWKT() AS "LINE_3857", P1.ST_MAKELINE(P2).ST_TRANSFORM(4326).ST_ASEWKT() AS "LINE_4326", 
	ENV.ST_ASEWKT() AS "RECT_3857", ENV.ST_TRANSFORM(4326).ST_ASEWKT() AS "RECT_4326" FROM (
